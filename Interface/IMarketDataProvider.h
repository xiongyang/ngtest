...
public:
	...
	virtual void subscribeInstrument(uint32_t instrumentID) = 0;
	virtual void unSubscribeInstrument(uint32_t instrumentID) = 0;
	virtual void subscribeAllInstrument() = 0;
	virtual void unSubscribeAllInstrument() = 0;
};
